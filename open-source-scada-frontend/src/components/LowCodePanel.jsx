...
const PALETTE = [
    ...
    section: 'Communication', colorKey: 'gray', nodes: [
      {
        ...
        fields: [{ k: 'slave_id', t: 'number', v: 1 }, { k: 'fn_code', t: 'select', v: '03', opts: '01|02|03|04' }, { k: 'register_address', t: 'number', v: 1 }, { k: 'data_type', t: 'select', v: 'Int16', opts: 'Boolean|Int16|Uint16|Float32' }, { k: 'poll_rate', t: 'number', v: 1 }],
        hasIn: false, hasOut: true
      },
      {
        type: 'modbus_write', abbr: 'MBW', label: 'Modbus Write',
        fields: [{ k: 'slave_id', t: 'number', v: 1 }, { k: 'fn_code', t: 'select', v: '06', opts: '05|06|16' }, { k: 'register_address', t: 'number', v: 1 }, { k: 'trigger', t: 'select', v: 'On Change', opts: 'On Change|Continuous' }],
        hasIn: true, hasOut: false
      },
      {
        type: 'websocket_ingress', abbr: 'WSI', label: 'WebSocket Ingress',
        fields: [{ k: 'domain_name', t: 'text', v: import.meta.env.VITE_WS_DOMAIN_NAME || 'localhost:5000' }, { k: 'sensor_id', t: 'text', v: 'Engine_01' }],
        hasIn: false, hasOut: true
      },
      {
        type: 'websocket_egress', abbr: 'WSE', label: 'WebSocket Egress',
        fields: [{ k: 'domain_name', t: 'text', v: import.meta.env.VITE_WS_DOMAIN_NAME || 'localhost:5000' }, { k: 'sensor_id', t: 'text', v: 'Remote_sensor' }],
        hasIn: true, hasOut: false
      },
  ...
  },
  {
    section: 'Signal Processing', colorKey: 'amber', nodes: [
      { type: 'threshold', abbr: 'THR', label: 'Threshold', fields: [{ k: 'operator', t: 'select', v: '>=', opts: '>|<|>=|<=|==|!=' }, { k: 'value', t: 'number', v: 50 }], hasIn: true, hasOut: true },
